...
unsigned char pchMessageStart[4] = { 0xd7, 0x9e, 0x4f, 0x8a};
int64 nChainStartTime = 1516933439;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, const CBlockIndex* pindex)
{
     ...
     if (nPoWHeight == 1)
       nSubsidy = 99000000 * COIN; //Premin: 10M
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fStrictPayToScriptHash = true; // Always active in Lioncoin
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Lioncoin,wish is a great Coin,Lioncoin,wish is a great Coin!!";
        CTransaction txNew;
      ...
      if (true  && (block.GetHash() != hashGenesisBlock))
        ...
        assert(block.hashMerkleRoot == uint256("0xe2ee752bc188818f7e4642f8013d43ed43ebf78f52cd3eb07ff3a7d8dcb21e6d"));
